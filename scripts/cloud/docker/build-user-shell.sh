...
setup
docker_build flowlogix/user-shell user-shell.dockerfile

docker_build flowlogix/user-shell:java-${JAVA_VERSION} user-java-shell.dockerfile
docker_push_tag flowlogix/user-shell java-${JAVA_VERSION} java
