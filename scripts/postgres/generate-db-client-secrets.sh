...
openssl pkcs8 -topk8 -inform PEM -outform DER -nocrypt -in $client_dir/postgresql.key -out $client_dir/postgresql.pk8
...
chmod og-rwx,g+rw $client_dir/*.key $client_dir/postgresql.crt $client_dir/*.pk8
rm -f $client_dir/*.csr $client_dir/*.srl
