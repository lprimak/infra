...
ln -s $cert_links_src/flowlogix.com/fullchain.pem $cert_links_dst/docker/cert.pem
ln -s $cert_links_dst/docker/cert.pem $cert_links_dst/docker/ca.pem
ln -s $cert_links_src/flowlogix.com/privkey.pem $cert_links_dst/docker/key.pem
